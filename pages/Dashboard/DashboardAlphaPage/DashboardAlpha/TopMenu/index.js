...
class TopMenu extends React.Component {
  ...
  onCameraLiftItemClick = (deviceInfo, type) => {
    ...
    if (!this.socketOpened) {
      ...
      console.log(messageInfo,"dragon");
  ...
  return (
    <ul className="dropdown">
      ...
      {decks.map(deck => {
        ...
        console.log(cameras, "66666666666666666666666666666666666666666666666666666666666666666666666")
        // console.log(deckLocations, "''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''")
          ...
          {cameraArray.filter(e => e.AuxDeviceID !== 1).map(camera => {
            ...
            return (
              <li>
                ...
                {(camera.status && camera.status[1] == "Raise")
                  ?
                  <ul
                    className="submenuItems"
                    style={
                  ...
                  >
                    <li style={{ backgroundColor: "#00efff", color: "rgba(30, 80, 150, 0.8)" }} onClick={itemClick.bind(this, camera, 2)}>UP</li>
                  ...
                  >
                    ...
                    <li style={{ backgroundColor: "#00efff", color: "rgba(30, 80, 150, 0.8)" }} 
                    onClick={itemClick.bind(this, camera, 3)}>DOWN</li>
                  </ul>
                }
