    ...
    return (
      ...
      >
        ...
        {curDevices.map(device => {
                ...
                case 2: {
                  if (isLiftCam) {
                    if (isLowered && isViewing && isSelected) {
                      ...
                      // buttonImage = 'resources/images/decks/cameras/2/Fixed Cam Right-Icon.svg' //magenta vikram
                      buttonImage = 'resources/images/decks/cameras/2/Fixed Cam Right-Up Icon.svg' //grey
                    } else if (isViewing) {// need lowered
                ...
                case 3: {
                  if (isLiftCam) {
                    if (isLowered && isViewing && isSelected) {
                      ...
                      buttonImage = 'resources/images/decks/cameras/2/PTZ Cam Right-Up Icon.svg' //grey
                      // buttonImage = 'resources/images/decks/cameras/2/PTZ Cam Right-Icon.svg' //magenta vikram
                    } else if (isViewing) {// need lowered
                      buttonImage = 'resources/images/decks/cameras/2/cameraFixedGreen.png'
                    }
                  } else {
                ...
                case 4: {
                  if (isLiftCam) {
                    if (isLowered && isViewing && isSelected) {
                      ...
                      buttonImage = 'resources/images/decks/cameras/2/360 Cam Right-Up Icon.svg' //grey
                      // buttonImage = 'resources/images/decks/cameras/2/360 Cam Right-Icon.svg' //magenta vikram
                    } else if (isViewing) {// need lowered
                      buttonImage = 'resources/images/decks/cameras/2/cameraFixedGreen.png'
                    }
                  } else {
          ...
          let isVisionCameraLower = device && device.status && device.status.includes('Lower')
          ...
          return (
            <div>
              ...
              >
                {EquipmentTypeID == 2 && ((isVisionCameraLower && receivedMotionDetection) || receivedMotionDetection) && <div className={'deviceButtonImage camera-icon-active'}>
                </div>}
